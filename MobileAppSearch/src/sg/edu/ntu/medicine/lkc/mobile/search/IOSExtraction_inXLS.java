...
/**
 *
 * @author Venugopal Giridharan working main program for ios
 *
 */
...
public class IOSExtraction_inXLS {

    private Properties prop = new Properties();
    String keywords[] = {"நீரிழிவு", "நீரிழிவு நோயாளர்", "நீரிழிவு நோய்", "குளுக்கோஸ்", "கிளைசெமிக்", "இரத்த சர்க்கரை", "இன்சுலின்", "dummy-test-12x"};
    boolean excelFileCreated;
    private HSSFWorkbook wb;
    private HSSFSheet sheet[] = new HSSFSheet[keywords.length];
    private int rowNumber = 1;
    private long searchStartFrom = 0;
    ...
    public void createExcelIO() {
        ...
        try {
            ...
            Logger.getLogger(IOSExtraction_inXLS.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
    ...
    public void executeScript(int shnum) throws IOException, InterruptedException {
        ...
        System.out.println(jsonStringResult.toString());
...
//              System.out.println(" Size: " + "   " + data.getSize());
    ...
    public static void main(String args[]) throws IOException, InterruptedException, NumberFormatException {
        // String keywords[] = {"糖尿", "血糖", "胰岛素", "胰島素", "dummy-test-12x"};
        IOSExtraction_inXLS obj = new IOSExtraction_inXLS();
        ...
        for (int i = 0; i < keywordsCount - 1; i++) {
            try {
                ...
                System.out.println("The trouble was caused by " + i);
                e.printStackTrace();
            }
        }
    }
